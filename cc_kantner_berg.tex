...
\usepackage{miniDBVzocker,amsthm}
...
\beginMinikarteNeu
	{\large #1}{\large #2}
%
\Grundsystem{\large Rieneck Standard mod. (5er Oberfarben)}
...
%
\ZweiTreffBed
	{bel. Semi/Partieforcing, starke SA 22+}
	{}
\ZweiTreffAnt{2\karo{} Relais, Rest nat}
\ZweiKaroBed
	{Weak Two in \karo\ (ca. 4-10F)}
	{}
\ZweiKaroAnt{2\SA{} Ogust (min-min-max-max); neue Farbe forcing}
\ZweiCoeurBed
	{Weak Two in \coeur}
	{}
\ZweiCoeurAnt{dito}
...
\item Assfrage ist generell RKCB 30/41, meist 4\SA
 \begin{itemize}
 \item Danach Spiral Scan (Bridge-Magazin 4/2011, S. 31)
...
\Doppelkarte{Henning Kantner}{Christoph Berg}
