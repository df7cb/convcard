...
\EinTreffAnt{Inverted (auch nach Zwischenreizung)}
	{3./4. Farbe forcing, Assfrage RKC 30/41, platzierte Könige, 4UF Assfrage bei Fit}
\EinKaroBed{4+ \karo}
\EinKaroAnt{(dito)}
	{}
\EinCoeurBed{5+ \coeur}
...
\EinSAGegen{16-18F}{11-14F}
	{}
\SprungGegen{Schwache Sprünge}
	{Schröder (Überruf = Zweif. mit anderer UF bzw. OF), Unusual 2\SA{} = untere beide ungereizte Farben}
%
\GegenEinSA
	{Starke SA: DONT (X = Einfärber, 2\treff/\karo/\coeur{} = 5/4+ (4/5+) Zweifärber, 2\pik{} = Piks)}
	{Schwache SA: Multi-Landy (2\treff{} = beide OF, 2\karo{} = OF-Einf., 2\coeur/\pik{} = 5-4+ \coeur/\pik-UF, 2SA{} = beide UF)}
	{\hphantom{Schwache SA:} X = Strafe}
\AndereGegenreizungen
	{Negativkontra (zeigt nach Zwr. auf 2er-St. 10+FP)}
	{neue Farbe auf 2er-Stufe nach Zwr. ist nicht forcierend}
	{Kontra gegen künstliche Gebote ist Ausspielmarke}
%
\SequenzHoechste{}
%\SequenzZweite{}
...
\AusspielSA{4.-höchste/TON, 2. der inneren Sequenz (bei 9 und 10)}
	{}
%\PositivHoch
\PositivNiedrig
%\PositivSonstiges{}
