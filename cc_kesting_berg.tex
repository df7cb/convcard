...
\EinTreffAnt{Inverted (auch nach Zwr.), Negativ-X (10+FP nach Zwr. auf 2er-St.), 2/1 NF nach Zwr.,}
...
\ZweiCoeurBed
	...
	{}
\ZweiCoeurAnt{2\pik{} Relais, 2\SA{} fragt}
\ZweiPikBed{Zweifärber \pik{} und UF (6-10FP)}
	{}
\ZweiPikAnt{3\treff{} Relais, 2\SA{} fragt}
...
\SprungGegen{Schwache Sprünge}
	{Schröder (Überruf = Zweifärber mit anderer UF bzw. OF), Unusual 2\SA{} auf OF-Eröffnung}
%
\GegenEinSA
	{DONT (X = Einfärber)}
	{}
...
\AusspielSonstiges{Klein zeigt Figur (TON)}
